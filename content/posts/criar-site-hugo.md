...
### Publishing the site
To see the procedure for publishing the site, just follow the steps I present [in this article]({{<relref "/posts/deploy-website-netlify">}}).
